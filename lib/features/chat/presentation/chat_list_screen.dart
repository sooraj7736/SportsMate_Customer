...
class _ChatListScreenState extends ConsumerState<ChatListScreen> {
  ...
  Widget _buildChatList(String currentUid) {
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                const Text("No messages yet", style: TextStyle(color: Colors.grey, fontSize: 18)),
              ],
            ),
          );
        }
              ...
              return ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ChatRoomScreen(groupChat: chat),
                    ),
                  );
                },
              );
                  ...
                  onTap: () {
                    if (athlete != null) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ChatRoomScreen(otherUser: athlete),
                        ),
                      );
                    }
                  },
